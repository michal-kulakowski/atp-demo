...
##Remediation
os.system('wall "\n########### REMEDIATING INCIDENT: Wannacry attack detected - threshold #############\n\n"')
os.system('wall "If I had an external system to talk to, I would quarantine IP '+hostIP+' and/or MAC '+hostMAC+' now."')
os.system('wall "\n\n####################################################################################"')
